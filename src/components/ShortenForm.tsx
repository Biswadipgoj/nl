...
// Returns the best base URL for displaying short links:
// 1. Uses NEXT_PUBLIC_BASE_URL env var (network-accessible IP) if set
// 2. Falls back to window.location.origin (localhost)
          ...
          <form onSubmit={handleSubmit}>
            <div className="form-row">
              ...
              >
                ...
                Options
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" style={{ transform: showSettings ? 'rotate(180deg)' : 'rotate(0)', transition: 'transform 0.2s' }}>
            ...
            {/* Error message */}
            {error && (
              <div style={{ marginTop: '10px', padding: '10px 14px', background: 'rgba(239,68,68,0.08)', border: '1px solid rgba(239,68,68,0.2)', borderRadius: '10px', fontSize: '0.8125rem', color: '#dc2626', display: 'flex', alignItems: 'center', gap: '6px' }}>
          ...
          <div className="result-panel">
            ...
            {showQR && (
              <div className="qr-panel">
                ...
                <div style={{ fontSize: '0.75rem', color: '#9ca3af', marginTop: '8px' }}>Scan to open this link</div>
              </div>
            )}
          </div>
        )}
